...
namespace Web.Services
{
    public class BasketViewModelService : IBasketViewModelService
    {
        ...
        public BasketViewModelService(IHttpContextAccessor httpContextAccesor, IAsyncRepository<Basket> basketRepository, IBasketService basketService, IAsyncRepository<Product> productRepository)
        {
